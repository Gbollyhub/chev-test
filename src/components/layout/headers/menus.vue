<template>
    <header class="sticky-top headernav">
		...
		<b-navbar toggleable="lg" class="chevron-navbar container">
			<b-navbar-brand href="#"><img src="../../../assets/images/chevron-cemcs.svg"/></b-navbar-brand>
